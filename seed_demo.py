...
def seed_demo():
    ...
    with app.app_context():
        ...
        print("  Super Admin: super@admin.com / super123")
        print("  Admin: admin@futbolelite.com / admin123")
        print("  Entrenadores:")
        for t in trainers:
            print(f"    - {t.email} / trainer123")
        print("\n👥 Atletas de prueba:")
        print("  Cualquier atleta: [nombre].[apellido]@futbolelite.com / athlete123")
        print("=" * 60)
